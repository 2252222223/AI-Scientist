...
from DB.DB_Manager_Tools.DA_tools.Data_Proessing_tools.Data_Proessing_Tools_integrated import Data_Proessing_tools_list
...
data_proess_agent = Departmental_Manager_agent(CONFIG, Data_Proessing_tools_list, Expert_experience_path=Expert_experience_path)
